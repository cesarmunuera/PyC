function codificacion_paredes = obtener_paredes(array_laser, distancia_sonar_derecho, distancia_sonar_izquierdo)
    %% Descripcion:
    % Esta funcion retorna la codificacion de las paredes que rodean al
    % robot. El codigo es muy similar al realizado en la primera practica.
    % Usamos el laser para tener una deteccion delantera y trasera, y 2
    % sonares para la parte derecha e izquierda.
