...
disp("La confianza del sonar 0 es del " + c0 + " %.")
disp("La confianza del sonar 1 es del " + c1 + " %.")
disp("La confianza del sonar 2 es del " + c2 + " %.")
disp("La confianza del sonar trasero es del " + ctrasero + " %.")